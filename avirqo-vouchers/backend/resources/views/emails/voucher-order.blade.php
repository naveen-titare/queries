...
<body style="font-family: 'DM Sans', -apple-system, Arial, sans-serif; color: #0D0D0C; max-width: 520px; margin: 0 auto; padding: 24px;">
  ...
  <p style="color: #6B6A67; margin: 0 0 20px;">
  ...
  <div style="background: #F7FAF9; border: 1px solid #E4EDE9; border-radius: 12px; padding: 16px 20px; margin-bottom: 20px;">
    ...
    <table style="width: 100%; border-collapse: collapse; font-size: 14px;">
      ...
      <tr>
        <td style="padding: 4px 0; color: #6B6A67;">{{ $item->product->name }} × {{ $item->quantity }}</td>
  ...
  <p style="color: #6B6A67; font-size: 13px; line-height: 1.6;">
    Please keep this email and the attached file secure. Voucher codes are sensitive —
    do not share them beyond the intended recipients.
  </p>

  <p style="color: #B4B2A9; font-size: 12px; margin-top: 24px;">
    This email was sent by Avirqo on behalf of {{ $customer->company_name }}.
    If you have any questions, please contact your Avirqo account manager.
  </p>
</body>
</html>
