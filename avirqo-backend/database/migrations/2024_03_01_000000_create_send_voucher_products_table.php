...
return new class extends Migration
{
    ...
    {
        Schema::create('send_voucher_products', function (Blueprint $table) {
            $table->id();
            $table->string('product_id')->unique(); // Xoxoday productId - external reference
            $table->string('name');
            ...
            $table->json('value_denominations')->nullable(); // e.g. [100, 500, 1000]
            ...
            $table->index(['is_active', 'usage_type']);
            $table->index('brand');
        });
    }
    ...
    {
        Schema::dropIfExists('send_voucher_products');
    }
};
