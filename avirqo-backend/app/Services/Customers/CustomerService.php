...
class CustomerService
{
    ...
    {
        // Get existing SPOCs with their order counts
        $existingSpocs = $customer->spocs()
            ->withCount(['voucherOrders as voucher_orders_count', 'sendVoucherOrders as send_voucher_orders_count'])
            ->get()
            ->keyBy('id');
