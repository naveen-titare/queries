...
{
    protected $fillable = [
        'proforma_invoice_id', 'product_id', 'brand', 'product_name', 'hsn_sac', 'currency_code',
        'denomination', 'quantity', 'unit_price', 'discount_percentage', 'discount_amount',
        'taxable_value', 'gst_rate', 'cgst_amount', 'sgst_amount', 'igst_amount', 'line_total', 'delivered_amount',
    ];
